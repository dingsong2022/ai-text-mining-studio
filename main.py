...
**제1조 수집하는 개인정보 항목 및 수집·이용 목적**

- 수집 항목: 아이디, 이름
- 수집·이용 목적: 학습 활동 기록 저장 및 관리, 학습 결과 확인, 이용자 식별
- 수집 방법: 이용자가 앱 이용 시 직접 입력
- 최소처리 원칙: 서비스 제공에 필요한 최소한의 정보만 수집하며, 위 항목 외의 개인정보는 수집하지 않습니다.

---

**제2조 개인정보 보유 및 이용 기간**

- 보유 기간: 해당 학년도 수업 종료 시까지 (원칙적으로 학년도 말 일괄 삭제)
- 파기 방법: 전자적 파일 형태로 저장된 경우 복원 불가능한 방법으로 영구 삭제
- 예외: 관련 법령에 따라 보존이 필요한 경우 해당 기간 동안 보관 후 파기

---

**제3조 개인정보의 제3자 제공 및 처리 위탁**

수집된 개인정보는 명시된 목적 이외에 제3자에게 제공하지 않습니다. 다만, 데이터 저장을 위해 아래 외부 서비스를 활용하고 있으며, 해당 서비스의 개인정보처리방침이 함께 적용됩니다.

- 수탁 업체: Google LLC (Google Sheets / Firebase 등)
- 위탁 업무: 학습 데이터 저장 및 관리
- 보유 기간: 위탁 계약 종료 또는 서비스 종료 시까지
- 참고: Google 개인정보처리방침 — policies.google.com/privacy

---

**제4조 개인정보 안전성 확보 조치**

- 수집 데이터는 Google Sheets/Firebase의 접근 권한 설정을 통해 운영 교사 외 접근을 제한합니다.
- 앱 내에서 타 이용자의 개인정보를 열람할 수 없도록 화면 표시를 제한합니다.
- 불필요해진 데이터는 즉시 삭제하며, 학년도 종료 후 일괄 파기합니다.
- 수집된 개인정보는 교육 목적 이외에 사용하지 않으며 외부 유출을 방지합니다.

---

**제5조 이용자의 권리 및 행사 방법**

이용자(학생) 및 법정대리인은 언제든지 다음의 권리를 행사할 수 있습니다.

- 열람 요구: 자신의 개인정보 처리 현황 열람
- 정정 요구: 오류가 있는 개인정보 정정
- 삭제 요구: 수집된 개인정보 삭제
- 처리정지 요구: 개인정보 처리의 정지

권리 행사는 담임교사 또는 운영 교사에게 서면·이메일 등으로 요청하실 수 있으며, 운영 교사는 지체 없이 조치합니다.

---

**제6조 만 14세 미만 아동의 개인정보 보호**

만 14세 미만 아동의 개인정보를 수집할 경우, 「개인정보 보호법」 제22조의2에 따라 법정대리인(부모 또는 보호자)의 동의를 받아야 합니다.

본 앱은 학교 수업 활동의 일환으로 운영되므로, 학교에서 배부하는 가정통신문 또는 학교 내 개인정보 수집 동의서를 통해 법정대리인 동의를 갈음합니다. 별도 동의서가 필요한 경우 운영 교사에게 문의하여 주시기 바랍니다.
...
- 보호책임자: 용인신촌중학교 송지은
- 연락처: dingsong@yshinchon.ms.kr / 031-8025-4710
- 소속 기관: 용인신촌중학교, 경기도 용인시
...
본 방침은 2026년 3월 24일부터 시행됩니다. 내용이 변경될 경우 앱 내 공지 또는 학교 가정통신문을 통해 사전 안내합니다.

본 개인정보처리방침은 「개인정보 보호법」 제30조에 따라 작성되었습니다.
""")
                    ...
                    **🔍 원리 설명:**
                    ...
                    if 'error' not in method2:
                        ...
                        with col1:
                            ...
                            # preprocessor에서 계산된 신뢰도 사용
                            confidence = method2.get('confidence', 30)  # 기본값 30%
